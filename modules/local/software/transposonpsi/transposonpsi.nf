...
process TRANSPOSONPSI {
    ...
    tuple meta(val), path(fasta)  // proteins.fasta

    output:
    // TODO nf-core: Named file extensions MUST be emitted for ALL output channels
    tuple val(meta), path "${prefix}.all.TPSI.allHits", emit: transposon_allhits
    tuple val(meta), path "${prefix}.all.TPSI.topHits", emit: transposon_tophits
    ...
    gaas_transposonPSI2grid.pl -f ${prefix}.fasta -o transposonPSI
